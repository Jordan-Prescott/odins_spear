...
class Put:
    ...
    def group_call_center_agents_levels(
    ...
    def group_call_center_forced_forwarding(
    ...
    def group_call_center_stranded_calls_unavailable(
        self, call_center_user_id: str, updates: dict
    ):
    ...
    def user_call_center_supervised_agents(
    ...
    def user_call_center_agents_update(
    ...
    def service_provider_device_tag(
    ...
    def service_provider_device_type_tag(
    ...
    def group_hunt_group_weighted_call_distribution(
    ...
    def group_trunk_groups_call_capacity(
        self,
        service_provider_id: str,
        group_id: str,
        ...
        updates = {"serviceProviderId": service_provider_id, "groupId": group_id}
    ...
    def user_id(self, user_id: str, new_id: str):
        ...
        data = {"userId": user_id, "newUserId": new_id}

        return self.requester.put(endpoint, data=data)

    def user_group_id_update(
        self, user_id: str, new_group_id: str, evaluate_only: bool = False
    ):
        """
