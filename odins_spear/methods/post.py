class Post:
    ...
    def auto_attendant_remove_user(
    ...
    def group_hunt_groups_remove_user(
        self, service_provider_id: str, group_id: str, user_id: str
    ):
    ...
    def user_shared_call_appearance_endpoint(
